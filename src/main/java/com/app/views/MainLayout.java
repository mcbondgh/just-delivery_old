...
import com.app.views.notification.NotificationView;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("Orders", OrdersView.class, LineAwesomeIcon.FILE.create()));
        nav.addItem(new SideNavItem("Notification", NotificationView.class, LineAwesomeIcon.FILE.create()));
